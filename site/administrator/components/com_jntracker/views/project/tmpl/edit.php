...
$document->addStyleSheet(JUri::root() . 'media/com_jntracker/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_jntracker&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="project-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_JNTRACKER_TITLE_PROJECT', true)); ?>
		<div class="row-fluid">
