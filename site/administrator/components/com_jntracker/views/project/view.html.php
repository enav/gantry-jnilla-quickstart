 ...
 * @since  1.6
 */
class JntrackerViewProject extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JNTRACKER_TITLE_PROJECT'), 'project.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_jntracker.project', $this->item->id);
		}
