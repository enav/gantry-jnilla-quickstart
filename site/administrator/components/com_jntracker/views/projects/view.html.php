...
/**
 * View class for a list of Jntracker.
 *
 * @since  1.6
 */
class JntrackerViewProjects extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JntrackerHelpersJntracker::addSubmenu('projects');
	...
	protected function addToolbar()
	{
		...
		$canDo = JntrackerHelpersJntracker::getActions();

		JToolBarHelper::title(JText::_('COM_JNTRACKER_TITLE_PROJECTS'), 'projects.png');
		...
		{
			JToolBarHelper::preferences('com_jntracker');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_jntracker&view=projects');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_JNTRACKER_PROJECTS_NAME'),
		);
	}
}
